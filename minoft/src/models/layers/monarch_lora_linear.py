...
class MonarchLoraLinear(StructuredLinear):
    ...
    def __init__(self, *args, nblocks:int=4, r:int=4, adapt:bool=True, **kwargs):
        ...
        self.blkdiag1 = nn.Parameter(torch.empty(nblocks, in_blkr, in_blksz))
        self.blkdiag2 = nn.Parameter(torch.empty(nblocks, out_blksz, out_blkr))
